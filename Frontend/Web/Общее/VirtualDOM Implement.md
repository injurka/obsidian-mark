...
![Результат монтирования DOM-дерева на страницу](https://amorgunov.com/assets/images/2020-08-03-create-own-virtual-dom/2.jpg)
...
![Как включить параметр Paint flashing](https://amorgunov.com/assets/images/2020-08-03-create-own-virtual-dom/4.gif)

И посмотрим на результат:

![Paint flashing в действии](https://amorgunov.com/assets/images/2020-08-03-create-own-virtual-dom/5.gif)
...
![Результат обновления измененных элементов](https://amorgunov.com/assets/images/2020-08-03-create-own-virtual-dom/6.gif)

А так же в DevTools на изменения в DOM-дереве:

![Результат обновления измененных элементов в DOM](https://amorgunov.com/assets/images/2020-08-03-create-own-virtual-dom/7.gif)
...
![Отображение кнопок в DOM](https://amorgunov.com/assets/images/2020-08-03-create-own-virtual-dom/8.jpg)
...
![Финальный результат](https://amorgunov.com/assets/images/2020-08-03-create-own-virtual-dom/9.gif)
## Источник
- #### [amorgunov](https://amorgunov.com/posts/2020-08-03-create-own-virtual-dom/)
