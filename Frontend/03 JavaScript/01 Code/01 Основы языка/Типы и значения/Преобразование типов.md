...
## Раздел из файла: `Типы данных и структуры/Преобразование типов (Типы данных).md`
...
Вспомогательные функции `StringCreate()` and `SymbolDescriptiveString()` выглядят следующим образом:
