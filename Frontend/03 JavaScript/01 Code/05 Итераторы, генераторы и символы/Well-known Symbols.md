...
`Symbol.iterator` — это, пожалуй, наиболее известный символ. Он позволяет определять, как объект должен перебираться с помощью инструкции [[for...of]] или [[spread (Синтаксис)|spread-оператора]] (и должен ли он перебираться вообще).  
