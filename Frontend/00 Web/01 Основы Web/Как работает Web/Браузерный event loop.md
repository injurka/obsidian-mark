...
Для детального изучения архитектуры Event Loop (JIT-компиляция V8, спецификация HTML, Libuv/Node.js, Web Workers, Scheduling APIs) см. [[Архитектура и механика цикла событий]].
