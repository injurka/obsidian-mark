...
4. **[[@extend и наследование|Расширение/Наследование (Extend/Inheritance)]]**:
...
6. **[[Функции SCSS|Встроенные функции (Built-in Functions)]]**:
...
10. **[[Импорт и модульная система|Импорт (Import)]]**:
