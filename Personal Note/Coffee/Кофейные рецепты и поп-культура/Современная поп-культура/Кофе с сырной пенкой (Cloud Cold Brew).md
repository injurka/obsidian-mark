...
<div class="recipe-single-column">
    ...
    <div class="recipe-block">
        ...
        <div class="recipe-taste-profile">
            <div class="taste-bar-row">
                ...
                <div class="taste-track"><div class="taste-fill" style="width: 60%; background: #4A2E1B;"></div></div>
            </div>
            <div class="taste-bar-row">
                <span class="taste-label">Сладость и соль</span>
                <div class="taste-track"><div class="taste-fill" style="width: 75%; background: #F6E2B3;"></div></div>
            </div>
            <div class="taste-bar-row">
                <span class="taste-label">Плотность пенки</span>
        ...
        <div class="recipe-cup-wrapper">
            <div class="recipe-iced-glass-diagram">
                ...
                <div class="diagram-ice-cube ice-pos-1" style="top: 80px;"></div>
                <div class="diagram-ice-cube ice-pos-2" style="top: 130px;"></div>
                <div class="diagram-ice-cube ice-pos-3" style="top: 160px;"></div>
                <div class="diagram-ice-cube ice-pos-4"></div>
                
                <!-- Слои Cloud Cold Brew -->
                <div class="iced-glass-layer layer-cloud-foam">Сырная пенка (Cheese Foam)</div>
                <div class="iced-glass-layer layer-cold-brew">Колд брю / Американо</div>
            </div>
        </div>
        <p style="text-align: center; font-size: 0.85rem; color: var(--text-muted); margin: 0.5rem 0 0 0;">Идеальный стакан: прямой хайбол <strong>300–350 мл</strong>.</p>
    </div>
    ...
    <div class="recipe-block" style="margin-top: 16px; background: var(--background-secondary); border-color: transparent;">
        ...
        <p style="margin: 0; font-size: 0.9rem; color: var(--text-muted); line-height: 1.6;">
            Концепция соленой сырной пенки (в Азии известная как 奶盖 — <em>nǎi gài</em>, где <em>nǎi</em> означает молоко, а <em>gài</em> — крышка или покрытие) изначально появилась в чайных домах Тайваня в начале 2010-х годов как дополнение к холодному зеленому чаю. Плотная солоноватая шапка идеально балансировала терпкость и сладость напитка. <br><br>
