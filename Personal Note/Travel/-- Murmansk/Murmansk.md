...
* **Бюджет проживания (3 ночи):** `~15 000 – 18 000 ₽` (комфортный номер в *Azimut Hotel Murmansk 4\** на площади Пять Углов).
* **Бюджет под ключ на 1 чел:** `~64 000 – 72 000 ₽` (авиабилеты с багажом `~13 500 ₽`, отель 4* `~16 500 ₽`, джип-тур в Териберку + снегоходы + пропуск `~9 800 ₽`, охота за сиянием `~5 000 ₽`, саамская программа с оленями и хаски `~7 000 ₽`, арктическая гастрономия `~14 000 ₽`).
