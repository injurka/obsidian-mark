...
| **Ручной маршрут метро** | `> [!METRO]- Метро` + строка системы | **Под активностью** | Станции, линии, цвета, направления и число остановок; одна строка таблицы = один отрезок | Пересадка Dongmen → Taipei Main → Songshan |
