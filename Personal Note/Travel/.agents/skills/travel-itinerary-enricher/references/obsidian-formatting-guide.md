...
| Тип Callout | Синтаксис | Назначение | Пример использования |
| :--- | :--- | :--- | :--- |
| **Совет / Лайфхак** | `> [!TIP]` | Секретные ракурсы, скидки, лотереи, приложения | Лотерея Lucky Land, YouBike 2.0, ракурс заката |
| **Важное правило** | `> [!IMPORTANT]` | Необходимые документы, тайминг, регистрация | Миграционная карта TWAC, бронь билетов TRA |
| **Критический запрет**| `> [!CAUTION]` | Законы с гигантскими штрафами, депортация | Запрет мяса (АЧС), запрет вейпов/IQOS |
| **Предупреждение** | `> [!WARNING]` | Погода, обезьяны, мошки, правила метро | Правило желтой линии в MRT, макаки на Шоушане |
| **Сводка / Резюме** | `> [!summary]+` | Главные финансовые и маршрутные итоги | Бюджет поездки под ключ в `Финансы.md` |
| **Свернутая галерея** | `> [!INFO]- Картинки` | Блок изображений внутри секций | Скриншоты карт, фото еды и достопримечательностей |
| **Справочная инфо** | `> [!NOTE]` | Розетки, напряжение, утилизация мусора | Тип вилок, культура чистоты |
