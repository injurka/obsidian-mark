...
* **Структура ночевок (всего 24 ночи: 22 ночи на Тайване + 2 транзитные в Гуанчжоу):**
  * Гуанчжоу (транзит) — **1 ночь** (05 ноя – 06 ноя, *Southern Airlines Pearl Hotel (North District)*, бесплатная бронь China Southern; отдельный номер — 150 CNY при заселении).
...
* **Бюджет под ключ на 1 чел:** **`~209 700 ₽`** (авиабилеты `55 412 ₽`, eVisa `4 800 ₽`, жилье на Тайване `80 557 ₽`, отдельный номер в транзитном отеле `~1 800 ₽`, транспорт `30 925 ₽`, питание `18 500 ₽`, активности `4 740 ₽`, связь и страховка `4 200 ₽`, сувениры `5 000 ₽`, резерв `3 800 ₽`).
