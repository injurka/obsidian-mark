...
* **Калиброванный бюджет проживания на Тайване (22 ночи):** **`~66 479 ₽`** (в среднем `~3 022 ₽ / ночь`).
* **Бюджет под ключ на 1 чел:** **`~193 900 ₽`** (авиабилеты `55 412 ₽`, eVisa `4 800 ₽`, жилье `66 479 ₽`, транспорт `30 925 ₽`, питание `18 500 ₽`, активности `4 740 ₽`, связь и страховка `4 200 ₽`, сувениры `5 000 ₽`, резерв `3 800 ₽`).
