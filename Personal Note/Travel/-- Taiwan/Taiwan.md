...
* **Калиброванный бюджет проживания на Тайване (22 ночи):** **`~80 308 ₽`** (в среднем `~3 650 ₽ / ночь`).
* **Бюджет под ключ на 1 чел:** **`~207 700 ₽`** (авиабилеты `55 412 ₽`, eVisa `4 800 ₽`, жилье `80 308 ₽`, транспорт `30 925 ₽`, питание `18 500 ₽`, активности `4 740 ₽`, связь и страховка `4 200 ₽`, сувениры `5 000 ₽`, резерв `3 800 ₽`).
