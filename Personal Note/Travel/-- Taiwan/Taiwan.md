...
* **Бюджет под ключ на 1 чел:** **`~193 900 ₽`** (авиабилеты `55 412 ₽`, eVisa `4 800 ₽`, жилье `66 479 ₽`, транспорт `30 925 ₽`, питание `18 500 ₽`, активности `4 740 ₽`, сувениры `5 000 ₽`, резерв `8 000 ₽`).
