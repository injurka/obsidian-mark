...
* **08:30 - 09:00** — Сборы и сдача багажа в WUYU:
    * Выселиться из номера, оставить чемоданы на стойке и взять только документы и небольшой рюкзак на завтрак.
...
* **10:00 - 10:35** — Возвращение в WUYU и получение багажа:
