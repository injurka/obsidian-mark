...
> **Ключевой хайлайт:** Около 38 минут на THSR до Таоюаня, спокойная пересадка на A18 и еще 17–20 минут на Airport MRT до терминала!
...
>    * Выйдя из турникетов THSR Taoyuan, следуйте по указателям к станции **Airport MRT A18**. На переход, турникеты и ожидание поезда заложено 22 минуты.
>    * Приложите карту EasyCard и садитесь на поезд в сторону аэропорта / Тайбэя.
>    * Выходите на **Airport Terminal 1 (A12)** или **Airport Terminal 2 (A13)**: официальный ориентир от A18 — 17 минут на экспрессе или 20 минут на обычном поезде. [Схема и время Airport MRT](https://www.taoyuan-airport.com/airport_mrt?lang=en).
...
* **11:38 - 12:00** — Пересадка THSR ➔ Airport MRT A18:
    * Следуйте по крытому переходу, пройдите турникеты по EasyCard и дождитесь следующего поезда в сторону аэропорта. Двухминутная пересадка здесь нереалистична, поэтому оставлен полноценный запас.

* **12:00 - 12:20** — Поезд Airport MRT (A18 ➔ Терминалы 1/2):
    * В пути 17 минут на экспрессе или около 20 минут на commuter train. Проверьте номер терминала в посадочном талоне до выхода из поезда.
...
* **12:20 - 14:30** — Регистрация на международный рейс в аэропорту TPE:
