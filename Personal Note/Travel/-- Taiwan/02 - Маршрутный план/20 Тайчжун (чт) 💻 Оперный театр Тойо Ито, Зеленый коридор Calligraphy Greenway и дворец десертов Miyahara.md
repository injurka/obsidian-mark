# 🗓️ День 20: Четверг (💻 Воркейшн)

> **Локация:** Тайчжун (Taichung / 台中).
> **Фаза тура:** 💻 Фаза 2 — Городской воркейшн (До 14:45 — футуристическая опера Тойо Ито, зеленый коридор Calligraphy Greenway и спешелти-кофе / 15:00–20:30 — работа в отеле / после 20:30 — десертный Хогвартс Miyahara).
...
>   * *Отель ➔ Дворец десертов Miyahara:* Автобусы 300–310 на восток прямо до остановки **Taichung Station (臺中車站)** (12 мин). Дворец Miyahara находится в 200 метрах от старого вокзала у реки Лючуань.
...
### ГОРОДСКОЙ СЛОТ (09:30 - 14:45: Calligraphy Greenway, кофе Mojocoffee и Опера Тойо Ито)
...
### ОСНОВНОЙ РАБОЧИЙ СЛОТ (15:00 - 21:00: Удаленная работа в отеле)

* **15:00 - 21:00** — **Удаленная работа за ноутбуком на оптоволоконном интернете (300–500 Мбит/с).**
    * *Контекст*: Комфортная рабочая атмосфера, закрытие задач, видеозвонки без лагов (соответствует 10:00 – 16:00 МСК). Суммарно за день — 7 часов полноценного рабочего дня.

---

### ВЕЧЕРНИЙ СЛОТ (После 21:00: Сказочный Хогвартс Miyahara и банк мороженого)

* **21:00 - 22:45** — Историческая кондитерская магия: **Miyahara (宮原眼科)** и **Fourth Credit Union (第四信用合作社)**.
...
* Городские поездки на автобусе/EasyCard: `~50 TWD` (~140 ₽).
* Обед на бульваре: `~250 TWD` (~700 ₽).
* Спешелти-кофе в Mojocoffee: `~160 TWD` (~450 ₽).
* Знаменитое мороженое в Miyahara / Fourth Credit Union: `~220 TWD` (~620 ₽).
* **Итого за день (без отеля):** около `680 TWD` (`~1 910 ₽`).
