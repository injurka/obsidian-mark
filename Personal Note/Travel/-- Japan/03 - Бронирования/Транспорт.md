...
| **12** | Miyajimaguchi ➔ Miyajima | ⛴️ JR Miyajima Ferry | ~10 мин | IC/касса, `200 JPY` *(план)* |
...
| **ИТОГО** | **Все перемещения** | — | — | **`~69 650 JPY` / `~37 611 ₽`** |
...
* [JR Miyajima Ferry](https://jr-miyajimaferry.co.jp/en/) принимает IC-карты;
  взрослый билет в одну сторону сейчас `200 JPY`, а специальный рейс с видом
  на Великие тории ходит только в отдельное дневное окно. Проверено 24.09.2026.
...
* [JR East N'EX TOKYO Round Trip Ticket](https://www.jreast.co.jp/en/multi/pass/nex.html)
  стоит `5 200 JPY`, но действует только для поездки туда и обратно через NRT;
  в open-jaw NRT/KIX закладывается обычный билет в одну сторону, а не этот pass.
